...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let secondProduct = multiply(c, firstProduct)[0];
  let messageTwo = `The product of ${a} and ${b} and ${c} is ${secondProduct}.`;
  // console.log([secondSum,secondProduct, messageOne, messageTwo]);
  return [secondSum,secondProduct, messageOne, messageTwo];
...
let finalProduct = multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0];
 let message = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${finalProduct}.`;
